...
\begin{lstlisting}[language=bash]
  $ fusesoc run --target sim_cocotb AFRL:device_converter:fast_axis_uart:1.0.0
\end{lstlisting}
...
The following pages contain module inline code documentation for the core and test benches.
